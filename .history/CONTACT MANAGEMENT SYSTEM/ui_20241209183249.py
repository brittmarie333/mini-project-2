    ...
    try:
        ...
        for line in lines:
            if line.startswith("ID:"):
                ...
                contact_data['name'] = line.split(":")[1].strip()
            elif line.startswith("Phone:"):
                contact_data['phone'] = line.split(":")[1].strip()
            elif line.startswith("Email:"):
                contact_data['email'] = line.split(":")[1].strip()
            elif line.startswith("Address:"):
                contact_data['address'] = line.split(":")[1].strip()
            elif line.startswith("Notes:"):
                contact_data['notes'] = line.split(":")[1].strip()
        ...
        print("Error: The contacts file could not be found.")
    except Exception as e:
